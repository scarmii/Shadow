...
namespace Shadow
{
	VkPrimitiveTopology ShadowToVkCvt::primitiveTopologyToVk(PrimitiveTopology primitiveTopology)
	{
		...
		SH_WARN("it seems like you've passed in an unknown PrimitiveTopology value");
		return VK_PRIMITIVE_TOPOLOGY_MAX_ENUM;
	}

	VkPolygonMode ShadowToVkCvt::polygonModeToVk(PolygonMode mode)
	{
		switch (mode)
		{
		...
		SH_WARN("it seems like you've passed in an unknown PolygonMode value");
		return VK_POLYGON_MODE_MAX_ENUM;
	}

	VkCullModeFlags ShadowToVkCvt::cullModeToVk(CullMode cullMode)
	{
		switch (cullMode)
		{
		...
		SH_WARN("it seems like you've passed in an unknown CullMode value");
		return VK_CULL_MODE_NONE;
	}

	VkFrontFace ShadowToVkCvt::frontFaceToVk(FrontFace frontFace)
	{
		switch (frontFace)
		{
		...
		SH_WARN("it seems like you've passed in an unknown FrontFace value");
		return VK_FRONT_FACE_MAX_ENUM;
	}

	VkBlendFactor ShadowToVkCvt::blendFactorToVk(BlendFactor factor)
	{
		switch (factor)
		{
		...
		SH_WARN("it seems like you've passed in an unknown BlendFactor value");
		return VK_BLEND_FACTOR_MAX_ENUM;
	}

	VkBlendOp ShadowToVkCvt::blendOpToVk(BlendOp op)
	{
		switch (op)
		{
			case BlendOp::Add:  return VK_BLEND_OP_ADD;
		}
		SH_WARN("it seems like you've passed in an unknown BlendOp value");
		return VK_BLEND_OP_ADD;
	}

	VkFormat ShadowToVkCvt::vertexAttributeTypeToVk(VertexAttribType type)
	{
		switch (type)
		{
		...
		SH_WARN("it seems like you've passed in an unknown VertexAttributeType value");
		return VK_FORMAT_UNDEFINED;
	}

	VkFilter ShadowToVkCvt::filterToVk(Sampler::Filter filter)
	{
		switch (filter)
		{
		...
		SH_WARN("it seems like you've passed in an unknown Sampler::Filter value");
		return VK_FILTER_MAX_ENUM;
	}

	VkSamplerAddressMode ShadowToVkCvt::addressModeToVk(Sampler::AddressMode addressMode)
	{
		switch (addressMode)
		{
		...
		SH_WARN("it seems like you've passed in an unknown Sampler::AddressMode value");
		return VK_SAMPLER_ADDRESS_MODE_MAX_ENUM;
	}

	VkBorderColor ShadowToVkCvt::borderColorToVk(Sampler::BorderColor borderColor)
	{
		switch (borderColor)
		{
	...
	VkFormat ShadowToVkCvt::imageFormatToVk(ImageFormat format)
	{
		switch (format)
		{
		...
		SH_WARN("it seems like you've passed in an unknown ImageFormat value");
		return VK_FORMAT_UNDEFINED;
	}

	VkAttachmentLoadOp ShadowToVkCvt::attachmentLoadOpToVk(AttachmentLoadOp loadOp)
	{
		switch (loadOp)
		{
		...
		SH_WARN("it seems like you've passed in an unknown AttachmentLoadOp value");
