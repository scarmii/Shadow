...
namespace Shadow
{
	...
	{
		SH_PROFILE_FUNCTION();
		s_vkCtx = new VulkanContext(windowHandle);

		s_vkCtx->m_vkDevice = new Device(s_vkCtx->m_vkInstance, s_vkCtx->m_windowHandle, s_layers);
		s_vkCtx->m_vkDevice->init(s_vkCtx->m_windowHandle);
	...
	void VulkanContext::createInstance()
	{
		...
		SH_TRACE("created vulkan instance");
